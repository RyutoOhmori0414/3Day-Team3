Shader "Team3/CurvedLit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Library/CurvedLitInput.hlsl"
            #include "Library/Passes/CurvedLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "Library/CurvedLitInput.hlsl"
            #include "Library/Passes/CurvedShadowCasterPass.hlsl"
            ENDHLSL
        }
    }
